          ...
          <Link href="/dashboard" className="flex items-center space-x-3 group">
            ...
            <div className="flex flex-col">
              <span className="text-xl font-bold text-gray-100 group-hover:text-white transition-colors tracking-tight">
                Polka<span className="text-purple-400">Invest</span>
              </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 text-sm mb-6">
              Invest in tokenized real-world assets on the Polkadot blockchain.
            </p>
        ...
        <div className="border-t border-gray-800 pt-8 pb-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-gray-500 text-xs">
              © {currentYear} PolkaInvest. All rights reserved. Built on Polkadot Hub TestNet.
            </div>
          </div>
        </div>
      </div>
