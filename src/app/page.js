  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setCryptoPrice((prev) => ({
        ...
        pas: prev.pas * (1 + (Math.random() * 0.01 - 0.005)),
      }));
    }, 3000);
          ...
          <div className="container mx-auto px-4 py-20 md:py-32 flex flex-col md:flex-row items-center gap-12">
            ...
            >
              <div className="flex items-center gap-2 mb-8">
                ...
                <span className="font-bold text-2xl">PolkaInvest</span>{" "}
              </div>
              <motion.h1
                variants={fadeIn}
        ...
        <section id="features" className="py-20">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-gray-300 max-w-2xl mx-auto">
                {" "}
                PolkaInvest makes decentralized investing simple, secure, and
            ...
            >
              ...
              <FeatureCard
                ...
                description="Connect your wallet and invest directly into chosen Decks using our native PTK token. Buy PTK easily using PAS on Polkadot Hub TestNet."
                variants={fadeIn}
              />
              <FeatureCard
                icon={BarChart3}
        ...
        <section id="benefits" className="py-20 bg-gray-950/50">
          <div className="container mx-auto px-4">
            ...
            >
              <BenefitCard
                icon={Shield}
                title="Polkadot Security"
                description="Leverage the shared security of the Polkadot relay chain for your DeFi investments."
                variants={fadeIn}
              />
              <BenefitCard
                icon={PieChart}
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <motion.p variants={fadeIn} className="text-gray-400 text-lg">
                Everything you need to know about investing with PolkaInvest.
              </motion.p>
            </motion.div>
            ...
            >
              {[
                ...
                },
                {
                  ...
                  answer:
                    "We currently support PAS, BTC, ETH, and a curated selection of DeFi assets on Polkadot Hub TestNet. More coming soon!",
                },
              ].map((faq, idx) => (
                <motion.div
                  key={idx}
